...
export const FinalClient = styled.div`
	display: flex;
	flex-direction: column;
	align-items: center;
	gap: .4em;
...
export const FinalClientImage = styled.img<{ selected?: boolean }>`
	width: 7em;
	border: 2px solid ${props => props.theme.color.dark_grey};
`;

export const FinalClientName = styled.span`
